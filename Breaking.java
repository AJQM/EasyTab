...
public interface Breaking {
	/**
	 * keeps track of the teams still in the tournament
	 * 
	 * 
	 */
	/**
	 * The original teams in the
	 * 
	 * @return
	 */
	 ...
	 * (teamsList): asks the user how many teams are breaking, makes a new
	 ...
	 * teams Breaking); initializes int breakRounds public final ArrayList<Team>
